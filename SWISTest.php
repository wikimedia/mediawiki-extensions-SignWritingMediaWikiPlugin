...
/** @defgroup bswphp bsw_encoding.php Tests
 *  Unit testing for the bsw_encoding.php file
 *  @ingroup test
 */

/** @defgroup cswphp csw_unicode.php Tests
 *  Unit testing for the csw_unicode.php file
 *  @ingroup test
 */

/** @defgroup kswphp ksw_display.php Tests
 *  Unit testing for the ksw_display.php file
 *  @ingroup test
 */

/** @defgroup fswphp fsw_search.php Tests
 *  Unit testing for the fsw_search.php file
 *  @ingroup test
 */

/** @defgroup mswphp msw_main.php Tests
 *  Unit testing for the msw_main.php file
 *  @ingroup test
 */

include 'msw_main.php';
/** 
 * @brief Unit Testing class
